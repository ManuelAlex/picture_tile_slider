...
return Stack(
  children: [
    Container(
       height: cardHeight,
          width: cardWidth,
      decoration: BoxDecoration(border: Border.all(color: borderColor??woodColor)),
      child:showSelectedIndex? Container( 
       
                        color: Colors.black12,
                        
                            ):switch(gameItems){
          GameItems.image=>itemImage!=null? Container(
          ...
          GameItems.letter=> itemString!=null? Tile(index: index, itemString: itemString):const SizedBox.shrink(),
          GameItems.number=> itemString!=null? 
         Tile(index: index, itemString: itemString):const SizedBox.shrink(),
        },),
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(fontFamily: '',
                              fontSize:isMobile?30: 50,fontWeight: FontWeight.bold),),
                        ),
                      ),
    );
  }
